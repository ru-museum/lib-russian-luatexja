...
\begin{itemize}
  ...
  \item 現在適正表記の出来るフォントには{\colH{800000}DejaVuSans}（DejaVuSerifは不可）、{\colH{800000}FreeSerif}、{\colH{800000}FreeSans}等があります。
\begin{table}[h]
\begin{center}
\begin{tabular}{l|l|l}
...
\end{table}\vspace{-4mm}
  ...
  詳しくは\textbf{\gtfamily 7.3.1 BibLaTeX内での翻字表記}を参照して下さい。
\end{itemize}
...
\end{verbatim}
  ...
  \item BibLaTeX内での翻字表記については\textbf{\gtfamily 7.3.1 BibLaTeX内での翻字表記}を参照して下さい。
